    ...
    while True:
      for frame in container.decode(video=0):
        ...
        def red_detect(canny):
          ...
          RGBLower1 = np.array([60, 60, 110])    # 抽出する色の下限(BGR)
          RGBUpper1 = np.array([81 ,80, 160])   # 抽出する色の上限(BGR)
          mask1 = cv2.inRange(image_origin, RGBLower1, RGBUpper1) 
        ...
        #thresh = cv2.threshold(mask,127,255,cv2.THRESH_BINARY_INV)
